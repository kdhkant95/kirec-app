...
function LoginContent() {
  ...
  useEffect(() => {
    fetch("/api/auth/providers")
      .then((r) => r.json())
      .then((p) => setHasGoogle("google" in (p ?? {})))
      .catch(() => {})
  }, [])
        ...
        <div className="space-y-3">
          {hasGoogle && (
            <button
              ...
              style={{ background: "#1a1a1a", border: "1px solid #27272a", color: "#fff" }}
            >
          ...
          <button
            ...
            style={{ background: "transparent", border: "1px solid #27272a", color: "#767d88" }}
          >
            목 데이터로 둘러보기
          </button>
        </div>
